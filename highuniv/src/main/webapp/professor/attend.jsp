			...
			<table>
				...
				<c:forEach var="attend" items="${AttendList}">
					<tr>
						...
						<td><span class="show">${attend.attend_remarks}</span> <input type="text" id="comment${num}"
						...
						function () {
							...
							if ($(this).text() === '수정') {
								...
								$("input.chk:checked").each(function () {
									...
									let subjectName = $row.find("td.subject_name").text();
									let statusSpan = $($row).children().eq(4).children("span");
									let commentSpan = $($row).children().eq(5).children("span");

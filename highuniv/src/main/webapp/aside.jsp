			    ...
			    <c:when test="${sessionScope.role == 'student'}">
			    	<nav class="ham-menu">
						<ul>
							...
							<li onclick="location.href='<%=request.getContextPath()%>/StudentLectureServlet';">강의정보</li>
			    ...
			    <c:when test="${sessionScope.role == 'professor'}">
					<nav class="ham-menu">
						<ul>
							...
							<ul class="sub-menu">
		                        <li onclick="location.href='<%=request.getContextPath()%>/professor/student_info/pr_student_into.jsp';">학생등록</li>
	                           	<li onclick="location.href='<%=request.getContextPath()%>/professor/student_info/studentlist.pr';">학생리스트</li>
                        	</ul>
...
//                     console.log(innerWidth);
                    ...
                    if(innerWidth > 768){
//                     	console.log(document.getElementsByClassName("ham-menu")[0]);

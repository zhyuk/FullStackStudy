...
form {
    ...
    border-radius: 10px;
    text-align: left; /* 폼 내부 텍스트는 왼쪽 정렬 */
}
...
form input#sample6_address,
form input#sample6_detailAddress,
form input#sample6_extraAddress {
    width: 100%;
    padding: 8px;
    font-size: 14px;
    border: 1px solid #ccc;
...
<body>
	...
	<form action="StudentModify" method="post" id="studentForm"
		...
		<div class="form-group">
			<span class="imagesize"> <%=student.getStudent_image() != null ? "<img src='" + student.getStudent_image() + "' alt='사진'>" : "사진 없음"%>
			</span>
		</div>
		<div class="form-group">

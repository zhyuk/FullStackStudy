...
public class StudentVO {
	...
	private String student_ph;
	private String student_birth;
	private String student_intoday;
	private int student_year;
	private String student_major;
	private String student_address;
	private String student_gender;
	private String student_status;
	private String student_use;
	...
	public String getStudent_ph() {
		return student_ph;
	}

	public void setStudent_ph(String student_ph) {
	...
	public String getStudent_intoday() {
		return student_intoday;
	}

	public void setStudent_intoday(String student_intoday) {
		this.student_intoday = student_intoday;
	}
	...
	public String getStudent_use() {
		return student_use;
	}

	public void setStudent_use(String student_use) {
		this.student_use = student_use;
	}

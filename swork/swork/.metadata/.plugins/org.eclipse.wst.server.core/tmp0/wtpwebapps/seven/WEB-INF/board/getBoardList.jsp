...
<body>
	...
	<nav id="searchNav" class="navbar navbar-expand-sm navbar-dark">
		<form action="getBoardList.do" class="form-inline" method="post">
			<select class="form-control" name="searchCondition" id="sel1">
				<option value="TITLE">제목</option>
				<option value="CONTENT">내용</option>
			</select> <input type="text" class="form-control mr-sm-2" name="searchKeyword"
	...
	<div class="container-fluid">
		...
		<div id="footer">
			<button id="conWriter" class="btn btn-primary" type="button">글쓰기</button>
		</div>
	</div>
</body>

  ...
  <form name="fm" action="/updateUser.do" method="post" onsubmit="return chk()">
    ...
    <div class="input-group mb-3">
      ...
      <c:choose>
	      ...
	      <input type="text" class="form-control innm" value="사용자" readonly>
...
<c:choose>
	...
	<c:otherwise>
	  	<button type="button" class="btn btn-primary" onclick="javascript:location.href='/index.jsp';">홈으로</button>
	</c:otherwise>
</c:choose>
	</div>
  </form>  

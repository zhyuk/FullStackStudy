...
<nav id="stNav"
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item"><a class="nav-link" href="/insertBoard.do">글쓰기</a>
		</li>
	</ul>
	<c:choose>
		...
		<c:otherwise>
			<ul class="navbar-nav nav-right">
				<li class="nav-item"><a class="nav-link" href="/joinForm.do">회원가입</a>
				</li>
...
<div id="subNavMenu" style="top: 55.82px;"
	...
	<ul class="navbar-nav nav-right">
		...
		<li class="nav-item"><a class="nav-link"
			<c:if test='${ userId ne null}'>href="/insertBoard.do"</c:if>>글쓰기</a>
		</li>
		<c:choose>
			<c:when test='${userId ne null}'>
				<li class="nav-item"><c:choose>
